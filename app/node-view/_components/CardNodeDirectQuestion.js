...
export function CardNodeDirectQuestion({ height, data }) {
  ...
  return (
    <div
      ...
      className="flex items-center justify-center rounded-md border-2 border-indigo-700 bg-gray-800 px-1 py-0.5"
    >
